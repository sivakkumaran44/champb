 ...
 return (
    <div className="container mx-auto p-4 space-y-6">
      ...
      <div className="relative w-full max-w-5xl">
        ...
        <CircleChevronDown
          className={`absolute right-3 top-1/2 transform -translate-y-1/2 text-slate-400 cursor-pointer transition-transform duration-300 ${isDropdownOpen ? 'rotate-180' : ''}`}
      ...
      {isDropdownOpen && (
        <Card className="mb-4 w-full max-w-5xl bg-slate-100 border border-slate-300 rounded-lg relative">
          <CardContent className="p-4 sm:p-6">
            <h2 className="text-sm font-medium text-emerald-700 mb-4">Choose your subject</h2>
      ...
      <Card className="mb-4 w-full max-w-4xl bg-slate-100 border border-slate-300 rounded-lg relative">
        <CardContent className="p-4 sm:p-6">
          <h2 className="text-2xl text-slate-700 font-bold mb-2">General Intelligence and Reasoning</h2>
