  ...
  return (
    <footer className="mt-6">
      <div className="max-w-9xl mx-auto px-4 sm:px-6 lg:px-8">
        <Card className="bg-slate-200 border-none rounded-xl">
          <CardContent className="p-4 sm:p-6">
            <div className="flex flex-col md:flex-row-reverse items-center space-y-3 md:space-y-0 md:space-x-4">
              <Image 
                ...
                alt="Helping hands"
                width={0}
                className="w-full md:w-4/12 max-w-full h-auto rounded-lg object-cover flex-none"
              />
              <div className="text-center md:text-left md:flex-1">
                <h2 className="text-2xl sm:text-3xl font-bold text-slate-700 mb-2">Here to help</h2>
                ...
                <Button 
                  variant="default" 
                  size="default"
                  className="bg-emerald-700 rounded-lg hover:bg-emerald-800 text-white py-2 px-4"
                  asChild
                >
